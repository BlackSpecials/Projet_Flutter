import 'package:chatappflutter/Components/drawer.dart';
import 'package:chatappflutter/Components/feed_post.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Chat app project",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
        backgroundColor: Colors.grey[400],
      ),
